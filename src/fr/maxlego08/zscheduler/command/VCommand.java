package fr.maxlego08.zscheduler.command;
...
import fr.maxlego08.zscheduler.zcore.utils.commands.Arguments;
import fr.maxlego08.zscheduler.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.zscheduler.zcore.utils.commands.CommandType;
import fr.maxlego08.zscheduler.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final SchedulerPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(SchedulerPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(SchedulerPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(SchedulerPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(SchedulerPlugin plugin, CommandSender sender, String[] args) {
