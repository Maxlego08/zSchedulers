...
import fr.maxlego08.zscheduler.zcore.utils.ZUtils;
import fr.maxlego08.zscheduler.zcore.utils.builder.ItemBuilder;
...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected int id;
	protected SchedulerPlugin plugin;
	...
	protected InventoryResult preOpenInventory(SchedulerPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(SchedulerPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, SchedulerPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, SchedulerPlugin plugin, Player player) {
	}
